...
from src.core.models import NewPharmacyLead, Pharmacy, Prescription
...
class TestPromptManager:
    ...
    def test_returning_customer_greeting(self, prompt_manager, sample_pharmacy):
        greeting = prompt_manager.get_returning_customer_greeting(sample_pharmacy)
    ...
    def test_lead_assessment_high_volume(self, prompt_manager, sample_high_volume_lead):
        assessment = prompt_manager.get_lead_assessment(sample_high_volume_lead)
    ...
    def test_lead_assessment_low_volume(self, prompt_manager, sample_low_volume_lead):
        assessment = prompt_manager.get_lead_assessment(sample_low_volume_lead)
    ...
    def test_missing_info_prompt_for_lead_complete(
        self, prompt_manager, sample_high_volume_lead
    ):
        prompt = prompt_manager.get_missing_info_prompt_for_lead(
            sample_high_volume_lead
        )
        assert prompt is None

    def test_missing_info_prompt_for_lead_incomplete(
        self, prompt_manager, incomplete_lead
    ):
