...
I don't recognize this number - are you a new pharmacy looking to learn about our services?"""
    ...
    def get_mock_response(self, context: ConversationContext, message: str, message_num: int) -> str:
    ...
    def execute_follow_up_actions(self, context: ConversationContext, print_output: bool = False) -> dict:
        """
