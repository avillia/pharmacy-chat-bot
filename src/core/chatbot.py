...
from env import OPENAI_API_KEY, PROMPTS_DIR, COMPANY_NAME, COMPANY_PHONE
...
class PharmacyChatbot:
    ...
    def __init__(self, openai_api_key: str | None = None, prompts_dir: str | None = None):
    ...
    def process_user_message(self, context: ConversationContext, user_message: str) -> str:
    ...
    def _handle_returning_customer(self, context: ConversationContext, message: str) -> str:
        pharmacy = context.pharmacy
        
        system_prompt = self.prompt_manager.get_returning_customer_system_prompt(pharmacy)
    ...
    def _extract_lead_info_with_openai(self, lead: NewPharmacyLead, message: str) -> None:
        try:
            ...
            if not lead.estimated_rx_volume and extracted_data.get("estimated_rx_volume"):
    ...
    def _generate_ai_response(self, system_prompt: str, user_message: str, conversation_history: list[str]) -> str:        
        try:
